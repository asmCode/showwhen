    ...
    <div id="movie_id___ID__" class="tv_show">
        ...
        <a href="__SOURCE_URL__" target="_blank" style="display: __COUNTER_DISPLAY__">
            <div class="tv_show_date">
                __DATE__
                <img class="main_tv_show_date_info_icon" src="/img/info_icon.png" alt="info">
            </div>
        </a>
        ...
        <div class="tv_show_meta_group">
            <a href="__WATCH_URL__" target="_blank">
                <img class="tv_show_channel" src="/img/channels/__WATCH_IMG__" alt="channel">
            </a>
            <a href="__IMDB_URL__" target="_blank">
                <div class="tv_show_imdb">
                    <img class="tv_show_imdb_logo" src="/img/imdb.png" alt="imdb">
